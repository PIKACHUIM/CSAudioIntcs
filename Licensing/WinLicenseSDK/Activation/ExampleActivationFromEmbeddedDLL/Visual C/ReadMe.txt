========================================================================
    BIBLIOTECA DE VÍNCULOS DINÁMICOS: ActivationDLL 
                                      Información general del proyecto
========================================================================

AppWizard ha creado este archivo DLL ActivationDLL.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación ActivationDLL.


ActivationDLL.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado ActivationDLL.pch y un archivo de tipos 
