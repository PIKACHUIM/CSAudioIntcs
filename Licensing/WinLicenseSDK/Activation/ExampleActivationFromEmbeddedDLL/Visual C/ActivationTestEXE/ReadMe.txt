========================================================================
    APLICACIÓN DE CONSOLA: ActivationTestEXE 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ActivationTestEXE.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación ActivationTestEXE.


ActivationTestEXE.vcxproj
...
ActivationTestEXE.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado ActivationTestEXE.pch y un archivo de tipos 
