VERSION 5.00
Begin VB.Form Form1 
   Caption         =   "Trial-Registration -Activation SDK"
   ClientHeight    =   8925
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6570
   ...
   Begin VB.Frame Activation 
      ...
      Begin VB.TextBox edDeactivate 
         ...
         Width           =   3855
      End
      Begin VB.CommandButton btnDeactivate 
         Caption         =   "Deactivate"
         Height          =   255
         Left            =   240
         TabIndex        =   32
...
Private Sub btnActivate_Click()
    ...
    Dim ServerOutput As String * &H5000
    
    Status = WLRegActivateSoftware(edActivate.Text, WinsockErrorCode, ServerOutput, 4000)
    
    If Status = wlActivationOk Then
        MsgBox ("Application activated successfully. Application will restart now")
        WLRestartApplication
    Else
        MsgBox ("There was an error activating your software. Error code = " + Str(Status))
        MsgBox ("Server Output = " + ServerOutput)
    End If
...
Private Sub btnDeactivate_Click()
    ...
    Status = WLRegDeactivateSoftware(edDeactivate.Text, WinsockErrorCode, ServerOutput, 4000)
    
    If Status = wlActivationOk Then
        MsgBox ("Application **deactivated**!!!. Application will restart now")
        WLRestartApplication
    Else
        MsgBox ("There was an error deactivating your software. Error code = " + Str(Status))
        MsgBox ("Server Output = " + ServerOutput)
    End If
End Sub
